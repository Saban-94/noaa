...
export const DriverList = ({ 
  ...
  return (
    <div className="space-y-8" dir="rtl">
          ...
          <motion.button
            ...
            className={`p-6 rounded-[2.5rem] border transition-all text-right shadow-sm relative overflow-hidden ${
              selectedDriverId === driver.id 
                ...
                : 'bg-white border-gray-100 text-gray-900 group hover:border-sky-200 hover:shadow-md'
            }`}
          >
            ...
            {selectedDriverId === driver.id && (
              <motion.div 
                layoutId="active-bg"
                className="absolute inset-0 bg-gradient-to-br from-sky-600 to-sky-700 pointer-events-none" 
              />
            )}

            <div className="relative z-10">
              {/* Performance Bar */}
              <div className="absolute -top-6 -right-6 -left-6 h-1 bg-gray-100/10">
                <motion.div 
                  initial={{ width: 0 }}
              ...
              <div className="mb-4">
                <h3 className="text-xl font-black mb-1 leading-none">{driver.name}</h3>
      ...
      {/* Detailed Driver Cards with Orders and Exit/Entry Animations */}
      <AnimatePresence mode="wait">
        <div key={selectedDriverId || 'all'} className="pt-4">
          <motion.div
